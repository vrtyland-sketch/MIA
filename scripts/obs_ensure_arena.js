...
/**
 * Přidá / obnoví Browser Source MIA_ARENA (team bar — 4 platformní Koje).
 */
...
const INPUT_NAME = "MIA_ARENA";
const URL = "http://127.0.0.1:3000/arena-overlay.html";
...
async function main() {
  ...
  console.log(
    JSON.stringify({
      ...
      inputName: INPUT_NAME,
      url: URL,
      hint: "Team bar — 4 coin-žrouti, live battle pózy při duelu."
    })
  );
